/**
 * The ManualSerializationHelper class provides methods for manually serializing objects to JSON and XML formats.
 */
public class ManualSerializationHelper {
  ...
  public static String toJson(Product product) {
    return String.format("{\"id\": %d, \"title\": \"%s\", \"category\": \"%s\"}",
